            ...
            >
                ...
                <div className="flex flex-col-reverse justify-end gap-3 sm:flex-row">
                    ...
                    <button
                        type="button"
                        onClick={() => navigate('/products')}
                        className="rounded-xl border border-zinc-800 px-6 py-3 text-sm font-semibold text-zinc-400 hover:text-white"
                    >
                        Cancel
                    </button>
                    ...
                    <button
                        type="submit"
                        disabled={saving}
                        className="flex items-center justify-center gap-2 rounded-xl bg-cyan-500 px-6 py-3 text-sm font-bold text-zinc-950 hover:bg-cyan-400 disabled:opacity-50"
                    >
